...
/*
 * Tests taken from: https://github.com/manishsaraan/email-validator/blob/master/test.js
 */
...
describe("emailValidator(value, rule)", function() {
  ...
  it("Should Be Valid", function() {
    validSupported.forEach(email => {
      const result = validateEmail(email, rule);
